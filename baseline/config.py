...
def parse_args():
    ...
    # ======================== SavedModel Configs =========================
    parser.add_argument('--savedmodel_path', type=str, default='../checkpoints/v2/')
    parser.add_argument('--ckpt_file', type=str, default='../checkpoints/v2/model_epoch_7_mean_f1_0.5573.bin')
    parser.add_argument('--best_score', default=0.55, type=float, help='save checkpoint if mean_f1 > best_score')

    # ========================= Learning Configs ==========================
    parser.add_argument('--max_epochs', type=int, default=1, help='How many epochs')
    parser.add_argument('--max_steps', default=1, type=int, metavar='N', help='number of total epochs to run')
